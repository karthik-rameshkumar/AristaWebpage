...
if( window == top ){
        ...
        similarproducts.b.appVersion="14.07.30.3";
...
similarproducts.b.distributor='Injekt';
...
//    },
    ...
    _google : {
        ...
        care: function(){
	        ...
	        if (testBucket !== 'StasGoogle_Holdback' && testBucket !== 'AboveFold_StasSerget_Holdback' && similarproducts.b.topBannerSerget && similarproducts.b.userData.uc == 'US')
            {
